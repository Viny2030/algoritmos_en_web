# =================================================================
# SCRIPT DE AUDITORÍA DE CARGAS FISCALES CON STREAMLIT Y DOCKER
# =================================================================
...
def generar_datos():
    """Genera datos sintéticos de obligaciones fiscales."""
    np.random.seed (42)
    random.seed (42)
    fake = Faker ('es_AR')
    Faker.seed (42)
...
def analizar_datos(df_cargas_fiscales, fecha_actual_referencia):
    """Realiza el análisis de auditoría y detección de anomalías."""
...
def main():
    ...
    if st.button ("Iniciar Análisis", help="Genera datos simulados y realiza el análisis completo"):
        ...
        if anomalias_ia_count > 0:
            st.info (
                f"IDs de obligaciones anómalas por Isolation Forest: {df_auditado[df_auditado['is_anomaly_ia'] == -1]['id_impuesto'].tolist ()}")
        ...
        # Gráfico 1: Monto Total por Tipo de Impuesto
        ...
        # Gráfico 2 & 3: Conteo y Monto por Estado
        ...
        # Gráfico 5: Distribución de los Montos
        ...
        # Gráfico 6: Detección de Anomalías por Monto (Z-score)
        ...
        # Gráfico 7: Detección de Anomalías (IA): Monto vs. Días hasta Vencimiento
