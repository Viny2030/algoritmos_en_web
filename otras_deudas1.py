...
def generar_datos():
    ...
    num_deudas = 50
    # Modificación: Usar datetime.now() para la fecha actual de referencia
...
# Función auxiliar para generar y analizar datos
...
def main():
    ...
    # Modificación: Ejecutar el análisis solo al presionar un botón
